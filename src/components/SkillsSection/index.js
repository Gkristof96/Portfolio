...
import { SkillsContainer, SkillsWrapper, TextWrapper, SkillWrapper, Description } from './SkillsElements'
const Skills = () => {
    return (
        <>
